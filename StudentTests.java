...
public class StudentTests {
	 ...
	 */
	@Test
	public void test11UnionException() {
		try {
			Statistician first = new Statistician();
	 ...
	 */
	@Test
	public void test12AddException() {
		try {
			Statistician first = new Statistician();
			Statistician second = null;
			first.add(second);
